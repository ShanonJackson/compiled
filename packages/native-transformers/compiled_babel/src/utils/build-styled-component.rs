...
use swc_core::ecma::ast::{
    ...
    Decl, Expr, ExprOrSpread, Ident, IdentName, IfStmt, JSXAttr, JSXAttrName, JSXAttrOrSpread,
...
fn styled_style_prop(variables: &[Variable]) -> Expr {
    ...
    let mut dynamic =
        build_css_variables_with_transform(variables, |expr| pick_function_body(expr));
