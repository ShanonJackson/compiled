...
const Wrapper = forwardRef(({
  ...
  return <C {...__cmpldp} style={__cmpls} ref={__cmplr} className={ax(["_4t3ipxbi _gx371q9c _1bt61i6y _1bb7idpf _wv4j6up6 _1nf9idpf _1dbovuon", __cmplp.disableClick && "_lcxvglyw", __cmplp.isIncrementPlanningBoard && "_g51qdabe", __cmplp.className])} />;
});
