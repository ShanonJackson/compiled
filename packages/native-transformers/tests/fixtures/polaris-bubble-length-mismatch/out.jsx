/* .tmp-swc-polaris-bubble-length-mismatch-1766021350766-a9a9575240081.tsx generated by @compiled/babel-plugin v0.38.1 */
;
...
class BubblePositioningComponent extends Component<BubblePositioningComponentProps, BubblePositioningComponentState> {
    ...
    updateStylesForProps = (ref: ElementRef<'div'> | null, { zPosition, centerPosition }: BubblePositioningComponentProps)=>{
        if (ref) {
            const { style } = ref;
...
export const DefaultBubbleComponent = ({ color, borderColor, isHovered, isSelected, isDragging, isHighlighted }: DefaultBubbleComponentProps)=><BubbleContentWrapper data-testid="polaris-lib-matrix.ui.bubble.default-bubble-component-wrapper" data-component-selector="bubble-content-wrapper-phaV">
...
export const DefaultBubbleClusterComponent = ({ items, color, borderColor, isHovered, isSelected, isDragging, isHighlighted }: DefaultBubbleClusterComponentProps)=><BubbleContentWrapper data-testid="polaris-lib-matrix.ui.bubble.default-bubble-cluster-wrapper" data-component-selector="bubble-content-wrapper-phaV">
		{!isDragging && <BubbleAurora isSelected={isSelected} isHighlighted={isHighlighted} borderColor={borderColor} color={color} isHovered={isHovered}/>}
		<DefaultBubbleContainer color={color} borderColor={borderColor} isHovered={isHovered} isSelected={isSelected} isHighlighted={isHighlighted} isDragging={isDragging}>
			<span>{getItemCountString(items)}</span>
		</DefaultBubbleContainer>
	</BubbleContentWrapper>;
export const SimpleDefaultBubbleClusterComponent = ({ items, isHovered, isSelected, isHighlighted }: ClusteredItemProps)=><BubbleContentWrapper data-testid="polaris-lib-matrix.ui.bubble.simple-default-bubble-cluster-wrapper" data-component-selector="bubble-content-wrapper-phaV">
...
export const SimpleDefaultBubbleComponent = ({ isHovered, isSelected, isHighlighted }: ItemProps)=><BubbleContentWrapper data-testid="polaris-lib-matrix.ui.bubble.simple-default-bubble-wrapper" data-component-selector="bubble-content-wrapper-phaV">
		<BubbleAurora isSelected={isSelected} isHighlighted={isHighlighted} color={N300} borderColor={N300} isHovered={isHovered}/>
		<DefaultBubbleContainer color={N300} borderColor={N300} isHovered={isHovered} isSelected={isSelected} isHighlighted={isHighlighted}/>
	</BubbleContentWrapper>;
export const SimpleDefaultBubbleWrapperComponent = (props: ItemWrapperProps)=><>{props.children}</>;
export const DraggableBubble = ({ children, id, itemIds, onDragStart, onDragEnd, canDrop = true }: DraggableBubbleProps)=>{
...
export const Bubble = memo(({ itemIds, isItemsDragDisabled }: BubbleProps)=>{
    ...
    const isHovered = useMemo(()=>intersection(itemIds, hoveredItem?.items || []).length > 0, [
        hoveredItem?.items,
        itemIds
    ]);
    const isSelected = useMemo(()=>intersection(selectedItems || [], itemIds || []).length > 0, [
        itemIds,
        selectedItems
    ]);
    const isHighlighted = useMemo(()=>!!highlightedItem && itemIds.includes(highlightedItem), [
        itemIds,
        highlightedItem
    ]);
    const setSelectionFromClickEvent = useCallback((e: MouseEvent<HTMLElement>)=>{
        ...
        if (selected.length === 0) {
            ...
            const otherSelected = [
                ...selected.filter((id)=>!itemIds.includes(id))
            ];
            setSelectedItems([
                ...otherSelected,
                ...itemIds
...
const BubbleContentWrapper = forwardRef(({ as: C = "div", style: __cmpls, ...__cmplp }, __cmplr)=>{
    ...
    return <C {...__cmplp} style={__cmpls} ref={__cmplr} className={ax([
        "_2rko1rr0 _vchhusvi _kqswh2mm _bfhk18uv _1bsb1osq _4t3i1osq",
        __cmplp.className
    ])}/>;
});
...
const BubbleAurora = forwardRef(({ as: C = "div", style: __cmpls, ...__cmplp }, __cmplr)=>{
    ...
    const { isHighlighted: isHighlighted, isSelected: isSelected, borderColor: borderColor, ...__cmpldp } = __cmplp;
    return <C {...__cmpldp} style={{
        ...__cmpls,
        "--_dwe3mo": ix(B700),
        "--_ijaz3l": ix(B500),
        "--_4r9qlu": ix(getConicGradient(isArray(__cmplp.borderColor) && __cmplp.borderColor.length > 0 ? __cmplp.borderColor : [
            N500
        ])),
        "--_s99dce": ix(!__cmplp.isSelected && 'content-box, border-box')
    }} ref={__cmplr} className={ax([
        "_2rko1rr0 _1ltvidpf _154iidpf _vchhusvi _kqswstnw _1bsb1osq _4t3i1osq _1lrw174u _12vemgnk _ouxlzzqy _qjkj9dsr _1y1mxe2f _15i1scqs _1canymdr _nqoi12c5",
        __cmplp.isHighlighted ? "_bfhksfwi" : __cmplp.isSelected ? "_bfhk1fp5" : "_bfhk18uv",
        !__cmplp.isSelected && !__cmplp.isHighlighted ? "_1itk1032" : "_1itkglyw",
        __cmplp.className
    ])}/>;
});
if (process.env.NODE_ENV !== "production") {
...
const DefaultBubbleContainer = forwardRef(({ as: C = "div", style: __cmpls, ...__cmplp }, __cmplr)=>{
    ...
    const { isDragging: isDragging, isHighlighted: isHighlighted, isSelected: isSelected, isHovered: isHovered, borderColor: borderColor, ...__cmpldp } = __cmplp;
    return <C {...__cmpldp} style={{
        ...__cmpls,
        ...
        "--_1t1rute": ix(!__cmplp.isSelected && isArray(__cmplp.borderColor) && __cmplp.borderColor.length > 0 && `linear-gradient(${__cmplp.isHighlighted ? B700 : __cmplp.isSelected ? B500 : __cmplp.isHovered ? N500 : __cmplp.color}, ${__cmplp.isHighlighted ? B700 : __cmplp.isSelected ? B500 : __cmplp.isHovered ? N500 : __cmplp.color}), conic-gradient(${getConicGradient(__cmplp.borderColor)})`),
        "--_dwe3mo": ix(B700),
        "--_ijaz3l": ix(B500),
        "--_1uodq60": ix(__cmplp.color),
        "--_1v5wkwx": ix(isArray(__cmplp.borderColor) && __cmplp.borderColor.length > 0 && 'content-box, border-box'),
        "--_sjyp98": ix(N0),
        "--_1i123mx": ix(N1000),
        "--_1hpfxaf": ix(B700),
        "--_18666h2": ix(B500),
        ...
        "--_1szru47": ix(N500),
        "--_1mkxsz2": ix(!__cmplp.isSelected && isArray(__cmplp.borderColor) && __cmplp.borderColor.length === 1 && `linear-gradient(${__cmplp.borderColor[0]}, ${__cmplp.borderColor[0]}), conic-gradient(${getConicGradient(__cmplp.borderColor)})`)
    }} ref={__cmplr} className={ax([
        "_2rko1rr0 _4cvr1h6o _1bah1h6o _11c8dcr7 _v5641bs3 _19itgqsr _1ltvidpf _154iidpf _1bsb1osq _4t3i1osq _kqswstnw _vchhusvi _1e0c1txw _1itkf0dn _1lrwwvw6 _12vemgnk _ouxlzzqy _qjkj9dsr _1y1m1t4w _ejyi168t _d0altlke _1yxgglyw",
        __cmplp.isDragging ? "_tzy4idpf" : "_tzy4kb7n",
        __cmplp.isHighlighted ? "_bfhksfwi" : __cmplp.isSelected ? "_bfhk1fp5" : "_bfhk1o7t",
        __cmplp.isHighlighted || __cmplp.isSelected || __cmplp.isHovered ? "_syazfl7h" : "_syazt8es",
        __cmplp.isHighlighted ? "_eyzj1c5c" : __cmplp.isSelected ? "_eyzj1p1s" : isArray(__cmplp.borderColor) && __cmplp.borderColor.length === 1 ? "_eyzj1gz2" : "_eyzj18q7",
        __cmplp.className
    ])}/>;
});
if (process.env.NODE_ENV !== "production") {
...
const BubblePositioningContainer = forwardRef(({ as: C = "div", style: __cmpls, ...__cmplp }, __cmplr)=>{
    ...
    const { isDragging: isDragging, isHovered: isHovered, ...__cmpldp } = __cmplp;
