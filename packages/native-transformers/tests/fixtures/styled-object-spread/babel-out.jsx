...
const ProjectCheckbox = forwardRef(({ as: C = "div", style: __cmpls, ...__cmplp }, __cmplr) => {
	...
	return (
		<C
			...
			ref={__cmplr}
			className={ax([
				"_zulpu2gc _n7zl1hrc _4cvr1h6o _1e0c1txw _4t3i1jfw _1bsb1osq _bfhkysee _dlecu2gc _1eq11h6o _15pj1txw _2x4gze3t _12hv12x7 _x5bdze3t _1rgf12x7 _clfdze3t _11pqze3t _q0a5ze3t _c3k8ze3t",
				__cmplp.className,
			])}
		/>
	);
