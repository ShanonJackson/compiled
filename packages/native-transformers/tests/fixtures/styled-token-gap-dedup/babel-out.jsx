...
const ModalBodyWrapper = forwardRef(({ as: C = "div", style: __cmpls, ...__cmplp }, __cmplr) => {
	...
	return (
		<C
			...
			style={__cmpls}
			ref={__cmplr}
			className={ax(["_zulpopcn _1e0c1txw _2lx21bp4", __cmplp.className])}
		/>
	);
});
...
const ProgressBarWrapper = forwardRef(({ as: C = "div", style: __cmpls, ...__cmplp }, __cmplr) => {
	...
	return (
		<C
			...
			style={__cmpls}
			ref={__cmplr}
			className={ax(["_zulpopcn _1e0c1txw _4cvr1h6o _1wpz1fhb", __cmplp.className])}
		/>
	);
});
if (process.env.NODE_ENV !== "production") {
...
export const Example = ({ isAlternate }) => (
	<div>
		<ModalBodyWrapper data-testid={isAlternate ? "alt" : "default"}>Content</ModalBodyWrapper>
		<ProgressBarWrapper>
			<span>Hello</span>
		</ProgressBarWrapper>
	</div>
